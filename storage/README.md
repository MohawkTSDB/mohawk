...
A storage plugin should implement the [Backend interface](/storage/backend.go). Each storage plugin is built for specific use case, with features that best suite this use case.
